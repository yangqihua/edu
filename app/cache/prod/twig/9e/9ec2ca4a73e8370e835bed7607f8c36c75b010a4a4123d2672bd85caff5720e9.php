...
class __TwigTemplate_52292f4b7ad4c5145af4c6a15a49a1ae80234b4b026d9faec8b2e6525659e7ed extends Twig_Template
{
  ...
  <div class=\"iframe-parent-content iframe-parent-full\" id=\"text-activity\" data-finish-time=\"";
        // line 5
        echo twig_escape_filter($this->env, $this->getAttribute(($context["text"] ?? null), "finishDetail", array()), "html", null, true);
        echo "\" data-disable-copy=\"";
        echo twig_escape_filter($this->env, ($context["enableCopy"] ?? null), "html", null, true);
        echo "\">
    <div class=\"text-activity-content\">";
        // line 6
        echo $this->getAttribute(($context["activity"] ?? null), "content", array());
        echo "</div>
  </div>
";
    }
