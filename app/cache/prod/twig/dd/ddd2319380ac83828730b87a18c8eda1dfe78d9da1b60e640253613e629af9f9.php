...
class __TwigTemplate_70227f876e0e1e546815d59d2b54d536b540e0741b7bfe2f5597ae86bc0f118e extends Twig_Template
{
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        // line 33
        echo "  ";
        $context["orderBy"] = ((array_key_exists("orderBy", $context)) ? (_twig_default_filter(($context["orderBy"] ?? null), "createdTime")) : ("createdTime"));
        // line 34
        echo "  ";
  ...
  <div class=\"es-filter\">
    <ul class=\"nav nav-sort\">
      <li><a href=\"";
        ...
        echo "</a></li><li><a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("classroom_explore", array("category" => $this->getAttribute(($context["category"] ?? null), "category", array(), "array"), "subCategory" => $this->getAttribute(($context["category"] ?? null), "subCategory", array(), "array"), "selectedthirdLevelCategory" => $this->getAttribute(($context["category"] ?? null), "thirdLevelCategory", array(), "array"), "tag" => array("tags" => ($context["tags"] ?? null)), "filter" => array("price" => ($context["price"] ?? null), "currentLevelId" => ($context["currentLevelId"] ?? null)), "orderBy" => "studentNum")), "html", null, true);
        echo "\" class=\"";
        ...
        echo "</a></li><li><a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("classroom_explore", array("category" => $this->getAttribute(($context["category"] ?? null), "category", array(), "array"), "subCategory" => $this->getAttribute(($context["category"] ?? null), "subCategory", array(), "array"), "selectedthirdLevelCategory" => $this->getAttribute(($context["category"] ?? null), "thirdLevelCategory", array(), "array"), "tag" => array("tags" => ($context["tags"] ?? null)), "filter" => array("price" => ($context["price"] ?? null), "currentLevelId" => ($context["currentLevelId"] ?? null)), "orderBy" => "recommendedSeq")), "html", null, true);
        echo "\" class=\"";
    ...
    <div class=\"filter hidden-xs\">
      ";
        ...
        if ($this->env->getExtension('AppBundle\Twig\WebExtension')->isPluginInstalled("vip")) {
          ...
          <li role=\"presentation\"class=\"";
            ...
            echo "\"><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("classroom_explore", array("category" => $this->getAttribute(($context["category"] ?? null), "category", array(), "array"), "subCategory" => $this->getAttribute(($context["category"] ?? null), "subCategory", array(), "array"), "selectedthirdLevelCategory" => $this->getAttribute(($context["category"] ?? null), "thirdLevelCategory", array(), "array"), "tag" => array("tags" => ($context["tags"] ?? null)), "filter" => array("price" => ($context["price"] ?? null), "currentLevelId" => "all"), "orderBy" => ($context["orderBy"] ?? null))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("全部"), "html", null, true);
            echo "</a></li>
          ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["level"]) {
                ...
                echo "\"><a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("classroom_explore", array("category" => $this->getAttribute(($context["category"] ?? null), "category", array(), "array"), "subCategory" => $this->getAttribute(($context["category"] ?? null), "subCategory", array(), "array"), "selectedthirdLevelCategory" => $this->getAttribute(($context["category"] ?? null), "thirdLevelCategory", array(), "array"), "tag" => array("tags" => ($context["tags"] ?? null)), "filter" => array("price" => ($context["price"] ?? null), "currentLevelId" => $this->getAttribute($context["level"], "id", array())), "orderBy" => ($context["orderBy"] ?? null))), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->getAttribute($context["level"], "name", array()), "html", null, true);
                echo "</a></li>
          ";
      ...
      ";
        ...
        if ((($context["price"] ?? null) == "all")) {
            // line 59
            echo "          ";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("classroom_explore", array("category" => $this->getAttribute(($context["category"] ?? null), "category", array(), "array"), "subCategory" => $this->getAttribute(($context["category"] ?? null), "subCategory", array(), "array"), "selectedthirdLevelCategory" => $this->getAttribute(($context["category"] ?? null), "thirdLevelCategory", array(), "array"), "tag" => array("tags" => ($context["tags"] ?? null)), "filter" => array("price" => "free", "currentLevelId" => ($context["currentLevelId"] ?? null)), "orderBy" => ($context["orderBy"] ?? null))), "html", null, true);
            echo "
        ";
        } else {
            // line 60
          ...
          ";
            // line 61
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("classroom_explore", array("category" => $this->getAttribute(($context["category"] ?? null), "category", array(), "array"), "subCategory" => $this->getAttribute(($context["category"] ?? null), "subCategory", array(), "array"), "selectedthirdLevelCategory" => $this->getAttribute(($context["category"] ?? null), "thirdLevelCategory", array(), "array"), "tag" => array("tags" => ($context["tags"] ?? null)), "filter" => array("price" => "all", "currentLevelId" => ($context["currentLevelId"] ?? null)), "orderBy" => ($context["orderBy"] ?? null))), "html", null, true);
            echo "
        ";
        }
        // line 63
