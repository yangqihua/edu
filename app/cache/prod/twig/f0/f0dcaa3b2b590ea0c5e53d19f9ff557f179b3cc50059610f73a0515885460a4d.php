...
class __TwigTemplate_030aa180e6f8e3a72375d44e9c4c41ab3713a62555a81cf41e9e04b27671f458 extends Twig_Template
{
    ...
    {
        // line 2
        $context["esBarMenu"] = ($context["status"] ?? null);
        // line 1
  ...
  <ul class=\"list-unstyled\">
    ";
        // line 10
        if (($context["testPaperResults"] ?? null)) {
            // line 11
            echo "      ";
            ...
            $context['_seq'] = twig_ensure_traversable(($context["testPaperResults"] ?? null));
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["testPaperResult"]) {
                ...
                // line 14
                echo "        ";
                $context["task"] = (($this->getAttribute(($context["tasks"] ?? null), $this->getAttribute($context["testPaperResult"], "lessonId", array()), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute(($context["tasks"] ?? null), $this->getAttribute($context["testPaperResult"], "lessonId", array()), array(), "array"), null)) : (null));
                // line 15
                echo "        <li>
          ...
          <a target=\"_blank\" href=\"";
            ...
            class=\"color-gray\">";
                // line 18
                echo twig_escape_filter($this->env, (($this->getAttribute(($context["task"] ?? null), "title", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["task"] ?? null), "title", array()), $this->getAttribute($context["testPaperResult"], "paperName", array()))) : ($this->getAttribute($context["testPaperResult"], "paperName", array()))), "html", null, true);
                echo "</a>
        </li>
      ";
                ++$context['loop']['index0'];
  ...
  <ul class=\"list-unstyled\">
    ";
        // line 39
        if (($context["homeworkResults"] ?? null)) {
            // line 40
            echo "      ";
            ...
            echo "      ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(($context["homeworkResults"] ?? null));
            $context['loop'] = array(
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["homeworkResult"]) {
                ...
                // line 43
                echo "        ";
                $context["task"] = $this->getAttribute(($context["tasks"] ?? null), $this->getAttribute($context["homeworkResult"], "lessonId", array()), array(), "array");
                // line 44
                echo "        ";
                $context["course"] = $this->getAttribute(($context["courses"] ?? null), $this->getAttribute($context["homeworkResult"], "courseId", array()), array(), "array");
                // line 45
                echo "        <li>
          <i class=\"es-icon es-icon-chevronright\"></i>
          <a target=\"_blank\" class=\"color-gray\" href=\"";
            ...
            ";
                // line 48
                echo twig_escape_filter($this->env, (($this->getAttribute(($context["task"] ?? null), "title", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["task"] ?? null), "title", array()), "")) : ("")), "html", null, true);
                echo "
          </a>
        </li>
      ";
            ...
            // line 52
            echo "      ";
            if ((($context["homeworkCount"] ?? null) >= 10)) {
                // line 53
                echo "        <li class=\"text-center\">
          <a class=\"color-gray\" href=\"";
                // line 54
