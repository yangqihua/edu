...
class __TwigTemplate_b72765848449d289644a143a428337c160fe24a212d289a265a9e614ec3fd37b extends Twig_Template
{
...
<div class=\"modal fade\" id=\"uploadModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">
  <div class=\"modal-dialog\">
    <div class=\"modal-content\">
      ...
      <div class=\"modal-body\">
        ...
        echo "</th>
          <th>";
        // line 17
        echo twig_escape_filter($this->env, (($this->getAttribute($this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("coin"), "coin_name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("coin"), "coin_name", array()), "")) : ("")), "html", null, true);
        echo "</th>
          <th>";
        // line 18
      ...
      <div class=\"modal-footer\">
        ...
        // line 33
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("用户下载附件扣除的%name%会在扣除50%之后添加到您的账户", array("%name%" => (($this->getAttribute($this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("coin"), "coin_name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("coin"), "coin_name", array()), "")) : ("")))), "html", null, true);
        echo "
          </div>
    ...
    {
        return "group/upload-modal.html.twig";
    }
    ...
    {
        return new Twig_Source("", "group/upload-modal.html.twig", "/Users/yangqihua/Sites/edusoho/app/Resources/views/group/upload-modal.html.twig");
    }
}
