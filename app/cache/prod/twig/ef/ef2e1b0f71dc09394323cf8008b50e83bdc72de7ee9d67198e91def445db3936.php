...
class __TwigTemplate_a548515325c004e1f0d5237eea015a7b1c22750b0c90186466733b39bf36a901 extends Twig_Template
{
...
";
        // line 4
        if ((((array_key_exists("member", $context)) ? (_twig_default_filter((isset($context["member"]) ? $context["member"] : null), false)) : (false)) &&  !twig_in_filter("auditor", $this->getAttribute((isset($context["member"]) ? $context["member"] : null), "role", array())))) {
            // line 5
            echo "  <div class=\"clearfix\">
     <button class=\"btn btn-primary btn-sm pull-right js-show-review-form\" ";
            // line 6
            if (( !(isset($context["userReview"]) ? $context["userReview"] : null) || ((array_key_exists("hideRereview", $context)) ? (_twig_default_filter((isset($context["hideRereview"]) ? $context["hideRereview"] : null), false)) : (false)))) {
  ...
  ";
            // line 8
            $this->loadTemplate("review/widget/review-form.html.twig", "review/widget/list.html.twig", 8)->display(array_merge($context, array("userReview" => (isset($context["userReview"]) ? $context["userReview"] : null), "reviewSaveUrl" => ((array_key_exists("reviewSaveUrl", $context)) ? (_twig_default_filter((isset($context["reviewSaveUrl"]) ? $context["reviewSaveUrl"] : null), null)) : (null)))));
        }
        // line 10
        echo "
";
  ...
  <div class=\"js-reviews\">
    <div class=\"media media-evaluate\">
      <div class=\"media-left\">
        ";
                // line 20
                echo $context["web_macro"]->getuser_avatar_link((isset($context["user"]) ? $context["user"] : null), "small", array(0 => "card"));
                echo "
      </div>
      <div class=\"media-body thread-post\">
        <div class=\"title\">";
          ...
          ";
                ...
                if ($this->getAttribute($context["review"], "meta", array())) {
                    echo "<span>";
                    echo twig_escape_filter($this->env, (((($this->getAttribute($this->getAttribute((isset($context["courseMap"]) ? $context["courseMap"] : null), $this->getAttribute($context["review"], "courseId", array()), array(), "array", false, true), "title", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute((isset($context["courseMap"]) ? $context["courseMap"] : null), $this->getAttribute($context["review"], "courseId", array()), array(), "array", false, true), "title", array()), "教学计划")) : ("教学计划")) . " ") . $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("完成进度")), "html", null, true);
                    echo ":";
        ...
        <div class=\"thread-subpost-container subcomments clearfix ";
          ...
          <div class=\"thread-subpost-content\">
            ";
                // line 55
                $this->loadTemplate("review/widget/subposts.html.twig", "review/widget/list.html.twig", 55)->display(array_merge($context, array("posts" => (isset($context["posts"]) ? $context["posts"] : null), "targetType" => ((array_key_exists("targetType", $context)) ? (_twig_default_filter((isset($context["targetType"]) ? $context["targetType"] : null), "course")) : ("course")), "canAccess" => ((array_key_exists("canAccess", $context)) ? (_twig_default_filter((isset($context["canAccess"]) ? $context["canAccess"] : null), false)) : (false)))));
                // line 56
                echo "          </div>
...
";
    ...
    {
        return array (  293 => 92,  291 => 91,  288 => 90,  279 => 88,  264 => 81,  248 => 78,  245 => 77,  236 => 73,  232 => 72,  225 => 68,  214 => 65,  212 => 64,  209 => 63,  203 => 60,  196 => 59,  194 => 58,  190 => 56,  188 => 55,  181 => 53,  178 => 52,  175 => 51,  172 => 50,  169 => 49,  166 => 48,  163 => 47,  161 => 46,  157 => 44,  147 => 42,  145 => 41,  141 => 40,  137 => 39,  132 => 36,  126 => 35,  122 => 34,  119 => 33,  113 => 32,  109 => 31,  103 => 28,  97 => 25,  85 => 24,  81 => 23,  75 => 20,  69 => 16,  66 => 15,  63 => 14,  51 => 13,  48 => 12,  46 => 11,  43 => 10,  40 => 8,  31 => 6,  28 => 5,  26 => 4,  23 => 3,  21 => 2,  19 => 1,);
    }
    ...
    {
        return new Twig_Source("", "review/widget/list.html.twig", "/Users/yangqihua/Sites/edusoho/app/Resources/views/review/widget/list.html.twig");
    }
}
