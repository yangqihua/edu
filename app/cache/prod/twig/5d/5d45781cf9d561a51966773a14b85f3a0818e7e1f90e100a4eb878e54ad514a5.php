...
class __TwigTemplate_04e0d5d2051178d28111130732ea096fbe506b01b466af0ba087b77023baa86d extends Twig_Template
{
...
\t          ";
      ...
      <div class=\"col-lg-3 col-md-4 course-sidebar\">
        ...
        foreach ($context['_seq'] as $context["key"] => $context["widget"]) {
            // line 68
            echo "          ";
            if ((((((($this->getAttribute($context["widget"], "showMode", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($context["widget"], "showMode", array()), "all")) : ("all")) == "classroom") && ($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "parentId", array()) > 0)) || (((($this->getAttribute(            // line 69
$context["widget"], "showMode", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($context["widget"], "showMode", array()), "all")) : ("all")) == "course") && ($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "parentId", array()) == 0))) || ((($this->getAttribute(            // line 70
...
$context["widget"], "renderType", array()) == "include")) {
                    // line 74
                    echo "              ";
                    $this->loadTemplate($this->getAttribute($context["widget"], "uri", array()), "course/course-show.html.twig", 74)->display(array_merge($context, array("course" => (isset($context["course"]) ? $context["course"] : null))));
                    // line 75
                    echo "            ";
                }
                // line 76
...
(isset($context["course_set"]) ? $context["course_set"] : null), "title", array()), "desc" => $this->env->getExtension('AppBundle\Twig\WebExtension')->getPurifyAndTrimHtml(strip_tags($this->getAttribute(        // line 93
(isset($context["course_set"]) ? $context["course_set"] : null), "summary", array()))), "link" => $this->getAttribute($this->getAttribute(        // line 94
(isset($context["app"]) ? $context["app"] : null), "request", array()), "uri", array()), "imgUrl" => $this->env->getExtension('AppBundle\Twig\WebExtension')->getFurl((($this->getAttribute($this->getAttribute(        // line 95
...
";
    ...
    {
        return new Twig_Source("", "course/course-show.html.twig", "/Users/yangqihua/Sites/edusoho/app/Resources/views/course/course-show.html.twig");
    }
}
