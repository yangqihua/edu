...
class __TwigTemplate_5da1528d3d59f5882fe4a227aa4df18866e600c513de7b13133bf943bb0bba62 extends Twig_Template
{
...
<ul class=\"media-list\">
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["material"]) {
            // line 5
            echo "    ";
            $context["task"] = (($this->getAttribute((isset($context["tasks"]) ? $context["tasks"] : null), $this->getAttribute($context["material"], "lessonId", array()), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["tasks"]) ? $context["tasks"] : null), $this->getAttribute($context["material"], "lessonId", array()), array(), "array"), null)) : (null));
            // line 6
            echo "
    <li class=\"media\">
      <div class=\"media-body\">
        <div class=\"mbs\">
          ";
            // line 10
            if (((isset($context["task"]) ? $context["task"] : null) && ($this->getAttribute((isset($context["task"]) ? $context["task"] : null), "status", array()) != "published"))) {
                // line 11
                echo "            ";
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("任务未发布，不能下载该资料"), "html", null, true);
                echo ")</span>
          ";
            } else {
                // line 13
            ...
            ";
                    ...
                    // line 17
                    echo "              <a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("course_material_download", array("courseId" => $this->getAttribute((isset($context["course"]) ? $context["course"] : null), "id", array()), "materialId" => $this->getAttribute($context["material"], "id", array()))), "html", null, true);
                    echo "\" target=\"_blank\">";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["material"], "title", array()), "html", null, true);
                    echo "</a>
            ";
        ...
        <div class=\"text-sm\">
          ...
          ";
            ...
            if ((isset($context["task"]) ? $context["task"] : null)) {
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("course_task_show", array("courseId" => $this->getAttribute((isset($context["course"]) ? $context["course"] : null), "id", array()), "id" => $this->getAttribute((isset($context["task"]) ? $context["task"] : null), "id", array()))), "html", null, true);
                echo "\" title=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["task"]) ? $context["task"] : null), "title", array()), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("任务%number%", array("%number%" => $this->getAttribute((isset($context["task"]) ? $context["task"] : null), "number", array()))), "html", null, true);
                echo "</a>
            <span class=\"bullet\">•</span>
          ";
            }
  ...
  ";
        ...
        if (!$context['_iterated']) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("课程暂无资料"), "html", null, true);
            echo "</li>
  ";
        }
...
";
    ...
    {
        return array (  142 => 46,  139 => 45,  130 => 43,  117 => 37,  106 => 34,  103 => 33,  96 => 30,  94 => 29,  90 => 27,  84 => 24,  81 => 23,  79 => 22,  75 => 20,  72 => 19,  64 => 17,  59 => 15,  52 => 14,  49 => 13,  41 => 11,  39 => 10,  33 => 6,  30 => 5,  25 => 4,  21 => 2,  19 => 1,);
    }
    ...
    {
        return new Twig_Source("", "course/tabs/material.html.twig", "/Users/yangqihua/Sites/edusoho/app/Resources/views/course/tabs/material.html.twig");
    }
}
