...
class __TwigTemplate_cac4b54f15eebf14c003aa46496f47333d8ea0d4cce206662fa1687f7e5fdcd0 extends Twig_Template
{
...
<span class=\"course-price-widget\">
  ...
  ";
        ...
        if ($this->getAttribute(($context["courseSet"] ?? null), "discountId", array())) {
            ...
            if ((twig_in_filter("full", ($context["shows"] ?? null)) || twig_in_filter("price", ($context["shows"] ?? null)))) {
                ...
                if ((($context["priceType"] ?? null) == "coin")) {
                    ...
                    echo twig_escape_filter($this->env, ($this->getAttribute(($context["courseSet"] ?? null), "minCoursePrice", array()) * $this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("coin.cash_rate")), "html", null, true);
                    echo " ";
      ...
      ";
                    ...
                    // line 11
                    echo "        <span class=\"price\">";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("%price%元", array("%price%" => $this->getAttribute(($context["courseSet"] ?? null), "minCoursePrice", array()))), "html", null, true);
                    echo "</span>
      ";
                }
                // line 13
  ...
  ";
            ...
            if ((twig_in_filter("full", ($context["shows"] ?? null)) || twig_in_filter("price", ($context["shows"] ?? null)))) {
                ...
                if (($this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("coin.coin_enabled") && ($this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("coin.price_type") == "Coin"))) {
                    // line 28
                    echo "        ";
                    if (($this->getAttribute(($context["courseSet"] ?? null), "minCoursePrice", array()) > 0)) {
                        echo " 
          <span class=\"price\">";
                        // line 29
                        echo twig_escape_filter($this->env, ($this->getAttribute(($context["courseSet"] ?? null), "minCoursePrice", array()) * $this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("coin.cash_rate")), "html", null, true);
    ...
    {
        return new Twig_Source("", "course/widgets/course-set-price.html.twig", "/Users/yangqihua/Sites/edusoho/app/Resources/views/course/widgets/course-set-price.html.twig");
    }
}
