...
class __TwigTemplate_7bccfa4cfc7403fc36beb155bf4a76a7e438318507f1d16cd9641b1777d86564 extends Twig_Template
{
    ...
    {
        // line 6
        $context["appDownload"] = (( !((array_key_exists("custom", $context)) ? (_twig_default_filter(($context["custom"] ?? null), 0)) : (0)) && $this->env->getExtension('AppBundle\Twig\WebExtension')->isESCopyright()) && $this->env->getExtension('AppBundle\Twig\WebExtension')->getSetting("mobile.enabled", null));
        // line 7
        ...
        // line 17
        $context["themeConfig"] = ((((array_key_exists("isEditColor", $context)) ? (_twig_default_filter(($context["isEditColor"] ?? null), false)) : (false))) ? ($this->getAttribute(($context["currentTheme"] ?? null), "config", array())) : ($this->getAttribute(($context["currentTheme"] ?? null), "confirmConfig", array())));
        // line 18
        $context["allConfig"] = $this->getAttribute(($context["currentTheme"] ?? null), "allConfig", array());
        // line 20
  ...
  ";
    ...
    ";
            ...
            if ((($context["code"] ?? null) == "friend-link")) {
                // line 40
                echo "      ";
                $this->loadTemplate((("default/" . ($context["code"] ?? null)) . ".html.twig"), "default/index.html.twig", 40)->display(array_merge($context, array("friendlyLinks" => ($context["friendlyLinks"] ?? null))));
                // line 41
                echo "    ";
                ...
                if ((($context["code"] ?? null) != "course-grid-with-condition-index")) {
                    ...
                    if ($asm89CacheBody2 === false) {
                        ob_start();
                            // line 44
                            echo "        ";
                            $this->loadTemplate((("default/" . ($context["code"] ?? null)) . ".html.twig"), "default/index.html.twig", 44)->display(array_merge($context, array("config" => $context["config"], "category" => ($context["category"] ?? null))));
                            // line 45
                            echo "        ";
                    ...
                    // line 47
                    echo "        ";
                    $this->loadTemplate((("default/" . ($context["code"] ?? null)) . ".html.twig"), "default/index.html.twig", 47)->display(array_merge($context, array("config" => $context["config"], "category" => ($context["category"] ?? null))));
                    // line 48
                    echo "      ";
                }
                // line 49
  ...
  ";
    ...
    {
        return new Twig_Source("", "default/index.html.twig", "/Users/yangqihua/Sites/edusoho/app/Resources/views/default/index.html.twig");
    }
}
